...
# Book Instances
odyssey = Book('A book with a blue spine', 'The Odyssey by Homer',
               '“But the great leveler, Death: not even the gods can defend a man, not even one they love, that day when fate takes hold and lays him out at last.”')
carson = Book('A book with a red spine', 'Autobiography of Red by Anne Carson',
              'XIII. HERAKLES\' KILLING CLUB\nLittle red dog did not see it he felt it\nAll events carry but one')
riddle = Book('A book with a black spine', 'A book about Anglo-Saxon riddles.',
              '...although contentious, most scholars agree the answer to the riddle \'I saw a...(There\'s a stain on the page here.) ...alone is a mirror.')
